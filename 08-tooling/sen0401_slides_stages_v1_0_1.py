...
CHAPTERS = [(n, "Mastering Bitcoin 3rd edition, chapter %d: %s" % (n, t)) for n, t in (lambda x: x["items"] if isinstance(x, dict) else x)(json.load(open(os.path.join(os.path.dirname(os.path.abspath(__file__)), "chapters_v1_0_1.json"))))]
