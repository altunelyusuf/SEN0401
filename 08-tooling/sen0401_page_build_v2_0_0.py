...
T = open(os.path.join(REPO, "08-tooling", os.environ.get("PAGE_TEMPLATE", "sen0401_page_template_v2_0_0.html"))).read()
...
out = os.path.join(REPO, "03-materials", N, "page", "sen0401_%s_page_v%s.html" % (N, os.environ.get("PAGE_VER", "2_1_0")))
